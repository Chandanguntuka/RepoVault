...
export declare const IDE: React.NamedExoticComponent<{
    ...
    Chat: React.MemoExoticComponent<({ "data-testid": testId, script, animationDelay, alternativeText, ...rest }: IDEChatProps) => import("react/jsx-runtime").JSX.Element>;
    Editor: React.MemoExoticComponent<React.ForwardRefExoticComponent<Omit<IDEEditorProps, "ref"> & React.RefAttributes<HTMLDivElement>>>;
};
export {};
