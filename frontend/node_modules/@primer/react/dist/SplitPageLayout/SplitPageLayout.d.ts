...
import type { PageLayoutContentProps, PageLayoutFooterProps, PageLayoutHeaderProps, PageLayoutPaneProps, PageLayoutSidebarProps } from '../PageLayout';
...
export declare const Sidebar: React.FC<React.PropsWithChildren<SplitPageLayoutSidebarProps>>;
...
export declare const SplitPageLayout: React.FC<React.PropsWithChildren<SplitPageLayoutProps>> & {
    ...
    Sidebar: React.FC<React.PropsWithChildren<PageLayoutSidebarProps>>;
